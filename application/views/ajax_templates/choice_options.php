...
<div class="custom-file-upload options-wrap">
						...
						<textarea rows="1" placeholder="Option <?php echo $i;?>  Text" id="option-<?php echo $i;?>-text" name="option-<?php echo $i;?>-text" cols="12" class="col-lg-3 col-md-3 col-sm-12 col-xs-12"></textarea>
